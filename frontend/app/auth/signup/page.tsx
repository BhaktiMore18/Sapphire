...
export default function SignupPage() {
  ...
  const getPasswordStrengthText = (strength: number) => {
    if (strength < 25) return { text: "Very Weak", color: "text-red-600" }
    if (strength < 50) return { text: "Weak", color: "text-orange-600" }
    if (strength < 75) return { text: "Good", color: "text-yellow-600" }
      ...
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <span className="text-2xl font-bold text-gray-900">Sapphire</span>
          </div>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Join Sapphire</h1>
          <p className="text-gray-600">Start your journey to a sustainable future</p>
        </div>
              ...
              <div>
                ...
                <div className="relative mt-1">
                  ...
                  {formData.confirmPassword && formData.password === formData.confirmPassword && (
                    <CheckCircle className="absolute right-10 top-3 h-4 w-4 text-green-600" />
                  )}
                </div>
              </div>
